...
setDT(cost)
costdata <- cost[stage<=stagemax,c('blind_id','stage','SHUNTRND','sex','racet','cum_cost','ATRESIAn')]
attach(costdata)
```
...
```{r lqmm random }
# Random slope model
cost.lqmm2 <- lqmm( cum_cost ~  SHUNTRND + stage, random = ~ 1 + stage, group = blind_id,
